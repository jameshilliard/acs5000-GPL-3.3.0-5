...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    Applications | Power Mgmt.: IPMI | Add/Edit device</td>
  </tr>
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td align="left" valign="middle" height="40"> <font class="paragHelp">Add Device</font></td>
        </tr>
        <tr> 
          <td width="25">&nbsp;</td>
          <td width="25" align="center" valign="top">&nbsp;</td>
          <td width="365" align="left" valign="middle"><div align="justify"><font class="textHelp">
		  This dialog window allows you to add and configure a new IPMI device.
		  </font></div></td>
        <tr> 
          <td width="25" height="40">&nbsp;</td>
          <td width="25" align="center" valign="middle" height="40"> <img src="../../Images/paragHelp.gif" alt="" width="25" height="25" border="0"></td>
          <td align="left" valign="middle" height="40"> <font class="paragHelp">Edit Device</font></td>
        </tr>
        <tr> 
          <td width="25">&nbsp;</td>
          <td width="25" align="center" valign="top">&nbsp;</td>
          <td width="365" align="left" valign="middle"><div align="justify"><font class="textHelp">
		  If you have selected an existent IPMI device clicking on "Edit", you can review and change its configuration.
		  </font></div></td>		  
        </tr>
        <tr> 
          <td width="25">&nbsp;</td>
