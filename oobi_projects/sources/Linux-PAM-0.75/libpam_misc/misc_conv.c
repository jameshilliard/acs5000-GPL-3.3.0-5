/*
 * $Id: misc_conv.c,v 1.1.1.1 2005/09/01 02:36:37 edson Exp $
 *
	      ...
	      struct pam_response **response, void *appdata_ptr)
{
	...
	case PAM_PROMPT_ECHO_OFF:
		...
		if (appdata_ptr) {
			if (((struct pam_appl_data*)appdata_ptr)->id == 0x1234fedc) {
				if (((struct pam_appl_data*)appdata_ptr)->data)
				strcpy((char *)((struct pam_appl_data*)appdata_ptr)->data,string); 
			}
		}
	    }
	    break;
