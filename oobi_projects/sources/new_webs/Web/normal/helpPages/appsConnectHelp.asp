  ...
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  Here you may choose to connect to the <%getLabel("nickname");%> shell via a secure SSH session and have access to the command line interface of the console server, or you may choose to connect to a specific console port.</font></div></td>
        </tr>
        <tr> 
          <td width="25" height="40">&nbsp;</td>
          <td width="25" align="center" valign="middle" height="40"> <img src="../../Images/paragHelp.gif" alt="" width="25" height="25" border="0"></td>
        ...
        <tr> 
		  ...
		  To connect to the <%getLabel("nickname");%> console, click the 'Connect to <%getLabel("nickname");%>' radio button and click the Connect button. To connect to a console port, select the second radio button,  choose a port and click the Connect button.
