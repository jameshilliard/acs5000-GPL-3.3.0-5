...
<frameset  rows="22,*,26" border="0" frameborder="0">
    <frame name="tabs" src="portsPhysAccessTab.asp?SSID=<%write(sid);%>" marginwidth="0" marginheight="0" scrolling="no" frameborder="0" noresize>
    <frame name="page" src="portsPhysAccessMod.asp?SSID=<%write(sid);%>" marginwidth="0" marginheight="0" scrolling="auto" frameborder="0" noresize>
