...
<div>
    <table class="bgColor5" border="0" cellpadding="0" cellspacing="0" width="100%" height="98">
        <tr>
           <td align="right" width="100%">           
                <table border="0" cellpadding="0" cellspacing="0" height="98" width="100%" align="right">
                    <tr>
                        <td class="bgColor5" align="right">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr valign="bottom" align="right">
                                    <td align="right"><a href="javascript:newWindow('/onlineHelp.asp', 'Help', 800, 600, 'yes');"><img src="/Images/help.gif" alt="" width="78" height="40" border="0"></a></td>
									<td width="78">&nbsp;</td>
                                </tr>
                            </table>     
                        </td>
