...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <td width="365" align="center" valign="middle" class="titleHelp" nowrap><br>Help<br>
    Administration | Notifications<br>New / Modify Email Notification</td>
  </tr>
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td width="365" align="left" valign="middle" height="20">&nbsp;</td>
        </tr>
        <tr> 
          <td width="25">&nbsp;</td>
          <td width="25" align="center" valign="top">&nbsp;</td>
          <td width="365" align="left" valign="middle"><div align="justify"><font class="textHelp">
		  <p>Enter the alarm string to trigger the email notification, 
		  destination email address, the text to describe the event and 
		  the SMTP IP address.</p> 
		  <p>Please consult the user manual and the 
		  network administrator for further details.</p></font></div></td>
        </tr>
        <tr> 
          <td width="25" height="20">&nbsp;</td>
          <td width="25" align="center" valign="top" height="20"> &nbsp;</td>
