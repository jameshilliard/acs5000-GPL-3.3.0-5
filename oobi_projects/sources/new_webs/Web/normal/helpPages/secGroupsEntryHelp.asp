...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    Security | Users and Groups<br>New/Modify Group</td>
  </tr>
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  Add a new group name and the users that will be in the group. 
		  Please refer to the user manual for more details.</font></div></td>
        </tr>
        <tr> 
          <td width="25" height="20">&nbsp;</td>
          <td width="25" align="center" valign="top" height="20"> &nbsp;</td>
