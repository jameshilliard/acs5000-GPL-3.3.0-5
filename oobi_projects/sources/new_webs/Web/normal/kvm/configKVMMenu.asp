...
<head>
   ...
   var pageName = "/normal/kvm/configKVMMenu.asp";
   var topItem = "CON";

   var menuPages = new Array;
   var i = 0;

   menuPages[i++] = new menuObj("GC", "General", "/normal/kvm/configKVMGeneral.asp");

   if (parent.family_model == "KVM")
     menuPages[i++] = new menuObj("DEV", "Devices", "/normal/kvm/configKVMDevice.asp");
   else
     menuPages[i++] = new menuObj("DEV", "KVM Ports", "/normal/kvm/configKVMDevice.asp");
...
<script language="JavaScript">
<!-- Begin Hide
  print_head_menu(20, 2, menuPages, "KVM");
// End Hide -->
</script>
