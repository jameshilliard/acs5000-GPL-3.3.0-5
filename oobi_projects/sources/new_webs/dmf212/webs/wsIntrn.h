 ...
 *
 * $Id: wsIntrn.h,v 1.2 2008/01/31 18:03:32 dsueiro Exp $
 */
...
extern char_t			*websSSLHostUrl;	/* secure URL for this host */
extern char_t			*websIpaddrUrl;		/* URL for this host */
extern char_t			*websSSLIpaddrUrl;	/* secure URL for this host */
extern int				websPort;			/* Port number */
extern int				SSL_PORT;			/* https Port number */
extern int				seclevel;			/* security level */
extern int				sslVer;				/* ssl version */
extern char				sslCipher[100];				 /*ssl cipher list*/
