...
//[RK]Jun/29/05 - Fiber from 2.4 kernel.
#include "mii_24.c"
...
static irqreturn_t __ei_interrupt(int irq, void *dev_id)
{
	...
	/*
	 * Workaround infinite interrupt storm caused by Linksys PCM100
...
static void __NS8390_init(struct net_device *dev, int startp)
{
	...
	//[RK]Jun/29/05 - Fiber from 2.4 kernel
	MiiWriteRegister(dev,(unsigned short) 0x1, (unsigned short) 0x0, (unsigned short) 0x2100);
