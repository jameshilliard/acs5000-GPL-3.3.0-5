...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    Security | Active Port Sessions</td>
  </tr>
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  This section shows the active sessions, as well as their identifications, features and usage statistics.</font></div></td>
        </tr>
        <tr> 
          <td width="25" height="40">&nbsp;</td>
          <td width="25" align="center" valign="middle" height="40"> <img src="../../Images/paragHelp.gif" alt="" width="25" height="25" border="0"></td>
        ...
        <tr> 
		  ...
		  Open sessions are displayed with their identifications 
		  and statistics data for login, session and CPU usage for 
		  the specific client. JCPU is for all processes attached 
		  to that port including running background processes. 
		  PCPU relates the current process time. 
		  </font></div></td>
        </tr>
        <tr>
