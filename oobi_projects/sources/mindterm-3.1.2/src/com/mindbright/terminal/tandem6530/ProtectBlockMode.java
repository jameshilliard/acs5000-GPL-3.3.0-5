...
public class ProtectBlockMode extends ModeBase {
    ...
    public void doClearMemoryToSpaces(int startRow, int startCol,
        ...
        pages[selectedPage].doClearMemoryToSpaces(startCol - 1, startCol - 1,
    ...
    public void doResetMoifiedDataTags() {
        pages[selectedPage].doResetMoifiedDataTags();
    }
    /* 3-44 */
    ...
    protected void getLine(StringBuffer buf, int row, int startCol, int endCol,
                           String eol) {
        char chars[] = pages[displayPage].getChars(row);
