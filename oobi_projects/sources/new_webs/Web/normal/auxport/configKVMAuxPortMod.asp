...
<form name="configForm" method="POST" action="/goform/Dmf" target="_parent">
        ...
        <input type="hidden" name="urlOk" value=<%write("/normal/auxport/configKVMAuxPort"+idx+".asp");%>>
        <input type="hidden" name="urlError" value=<%write("/normal/auxport/configKVMAuxPort"+idx+".asp");%>>
