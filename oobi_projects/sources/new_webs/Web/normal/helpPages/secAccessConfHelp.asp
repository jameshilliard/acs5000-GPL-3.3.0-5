...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <%if ((FamilyModel == "ACS")||(FamilyModel == "AVCS"))
		write("Security | Authentication | AuthType</td>");
	  else
		write("Configuration | Authentication | AuthType</td>");
	%>
  </tr>
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  <p>Enter the authentication method used for the access to the box. 
		  You should configure the required authentication server setting first,
		  before making the authentication type selection.  Please consult your
