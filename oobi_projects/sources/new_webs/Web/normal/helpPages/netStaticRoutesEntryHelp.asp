...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    Network | Static Routes | New / Modify Route</td>
  </tr>
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  <p>This section defines the default static route and static routes to other hosts and networks.</p>
		  <p>Choose the route type and the IP and the gateway or interface. Static routes are a very quick way to route data, and are managed manually.</p>
</font></div></td>
        </tr>
        <tr> 
          <td width="25" height="20">&nbsp;</td>
