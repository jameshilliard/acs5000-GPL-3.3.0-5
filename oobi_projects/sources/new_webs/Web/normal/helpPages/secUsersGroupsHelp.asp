  ...
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  Users and Groups are created and configured in this section.</font></div></td>
        </tr>
        <tr> 
          <td width="25" height="40">&nbsp;</td>
          <td width="25" align="center" valign="middle" height="40"> <img src="../../Images/paragHelp.gif" alt="" width="25" height="25" border="0"></td>
        ...
        <tr> 
          ...
          <td width="365" align="left" valign="middle"><div align="justify"><font class="textHelp">
		  	<p>Clicking on [Add] under "User List" brings a dialog box to enter the user name,
			 type and password. To delete a user, select the user and click [Delete]. 
			 To change a password, select the user and click [Change Password].</p>
			<p>Clicking on [Add] under the "Group List" brings a dialog box. 
			Fill in the fields. To delete a group, select the group and click [Delete]. 
			To edit, select the group and click [Edit].<br><br> For details on how to manage 
			users and groups please consult the user manual.</p>
			</font></div></td>
        </tr>
        <tr>
