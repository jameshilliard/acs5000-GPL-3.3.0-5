...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    Ports | Physical Ports | Other Port Settings</td>
  </tr>
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  <p>Enter specific communication parameters for this 
		  port as you may require. Please consult the user 
		  manual and the network administrator. If you are 
		  connecting a Windows EMS server, check the appropriate box.</p></font></div></td>
        </tr>
        <tr> 
          <td width="25" height="20">&nbsp;</td>
          <td width="25" align="center" valign="top" height="20"> &nbsp;</td>
