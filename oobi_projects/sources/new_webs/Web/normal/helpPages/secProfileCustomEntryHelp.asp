...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    Security | Security Profile<br>Custom Profile</td>
  </tr>
    ...
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td width="365" align="left" valign="middle"><div align="justify"><font class="textHelp">
			All security options are shown in this page grouped under their categories.<br>
			Here you can adjust each of them to fit specific needs as desired.<br><br>
			Please refer to the user manual for more details on each individual option.</font></div></td>
        </tr>
        <tr> 
          <td width="25" height="20">&nbsp;</td>
          <td width="25" align="center" valign="top" height="20"> &nbsp;</td>
