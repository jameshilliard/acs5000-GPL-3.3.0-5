...
public class Parser implements AsciiCodes {
    ...
    public char parse(char inC) throws ParseException {
        ...
        case SMAJOR_ESC:
            ...
            default:
                setState(SMAJOR_GROUND);
                error("Unknown escape sequence Esc " + inC);
            }
            break;
        ...
        case SMAJOR_ESC_SPACE:
            ...
            default:
                setState(SMAJOR_GROUND);
                error("Unknown escape space sequence Esc " + inC);
            }
            break;
            ...
            case SMINOR_SET_TERM_CONF:
                if (inC == CR) {
                    ...
                    if (params.length > 0 &&
                        ...
                        setState(SMAJOR_GROUND);
                        error("Escv", "Value must be a number");
                    }
                    if (ah != null) {
