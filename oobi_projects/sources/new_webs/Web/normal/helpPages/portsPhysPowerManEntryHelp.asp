...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    Ports | Physical Ports | Power Management <br> Add Outlet</td>
  </tr>
    ...
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td width="365" align="left" valign="middle"><div align="justify"><font class="textHelp">
		  	<p>Choose the name of the power management ports or enter an outlet number you would like to be associated to this serial port for Integrated Console and Power Management.</p>
			Please see the manual for more details on this subject.
			</font></div></td>
        </tr>
        <tr>
