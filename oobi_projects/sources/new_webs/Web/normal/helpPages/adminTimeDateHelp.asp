  ...
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  <p>Set timezone and enter the system Date and Time.<br>
	         Network Time Protocol can also be used.</p></font></div></td>
        </tr>
        <tr> 
          <td width="25" height="40">&nbsp;</td>
          <td width="25" align="center" valign="middle" height="40"> <img src="../../Images/paragHelp.gif" alt="" width="25" height="25" border="0"></td>
        ...
        <tr> 
		  ...
		  <p>If you do not want to use a NTP server, disable NTP and enter the time and date.
          If you want to use a NTP server, enable NTP and enter its IP address.<br>
		  Timezone is set independently.</p>
		  </font></div></td>
        </tr>
        <tr>
