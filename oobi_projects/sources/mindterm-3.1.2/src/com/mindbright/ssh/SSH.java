...
public abstract class SSH {
    ...
    public final static String CVS_NAME      = "$Name: ACS5000-Branch-V_3_3_0-5-Sep_01_2010 $";
    public final static String CVS_DATE      = "$Date: 2007/11/09 18:02:10 $";
    ...
    public final static int    CIPHER_DEFAULT  = CIPHER_BLOWFISH; // Triple-DES is default block-cipher
