...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    Ports | Physical Ports<br>
	General Port Setting</td>
  </tr>
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  Choose the protocol to be used with the server's console 
		  connected to this port and the communication parameters. 
		  9600 baud is the default speed for most servers. </font></div></td>
        </tr>
        <tr> 
          <td width="25" height="20">&nbsp;</td>
          <td width="25" align="center" valign="top" height="20"> &nbsp;</td>
