  ...
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  You can use this section to manually add routes. Static routes are a very quick and
		   effective way to route data from one subnet to different subnets. Please consult the
		    manual on how to manage them. 
		  </font></div></td>
        </tr>
        <tr> 
          <td width="25" height="40">&nbsp;</td>
        ...
        <tr> 
		  ...
		  You can add or edit a hard coded static route by clicking on the corresponding buttons.
		   They'll bring you to a dialog box to enter the route to be added. To delete a static route,
		    highlight the route and hit [Delete]. [Up] and [Down] buttons moves your entry through the table. 
		  </font></div></td>
        </tr>
        <tr>
