  ...
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  The rules of ipchains can be configured in this section to set the rules for filtering packets.
		  </font></div></td>
        </tr>
        <tr> 
          <td width="25" height="40">&nbsp;</td>
        ...
        <tr> 
		  ...
		  IP chains is a method to match and filter packets. This section allows you to set ipchains rules
		   in the way you want. You can click on the [Add] button to add a new entry, or select one entry to Edit
		    or Delete. To change the rules, click on [Edit Rules] and then add, delete or add entries to open a
			 dialog box. The dialog box shall be filled to reflect your requirements, while [Up] and [Down] places
			  the entry in the position you want. Rules do change with each network. Please consult the manual for
