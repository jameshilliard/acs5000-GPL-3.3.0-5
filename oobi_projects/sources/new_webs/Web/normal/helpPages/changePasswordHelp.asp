<html>
<head>
	<title>Help/Change Password</title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <td width="365" align="center" valign="middle" class="titleHelp" nowrap><br>Help<br>
      Security | Users and Groups<br>Change Password<br></td>
  </tr>
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<tr> 
		  ...
		  <font class="textHelp">Select a user and enter the new password for this user. 
		  The old password is never shown. Please see the user manual for further details.</font></div> </td>
        </tr>
		<tr> 
          <td width="25">&nbsp;</td>
          <td width="25" align="center" valign="top">&nbsp;</td>
