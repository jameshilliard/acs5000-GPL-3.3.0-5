/* $Id: sedlbauer.c,v 1.1 2007/07/20 16:51:37 rborin Exp $
 *
...
ready:	
	 ...
	 * here, it would fail.
	 */
	//[RK]Sep/06/05 - fixed problem : Trying to free nonexisten resource
	if (!request_region(cs->hw.sedl.cfg_reg, bytecnt, "sedlbauer isdn") &&
	    (cs->hw.sedl.bus != SEDL_BUS_PCMCIA)) {
//	if (cs->hw.sedl.bus != SEDL_BUS_PCMCIA &&
