...
/*
 * $Id: pam_warn.c,v 1.1.1.1 2005/09/01 02:36:37 edson Exp $
 *
			...
			, const char **argv)
{
	 ...
	 (void) pam_get_item(pamh,PAM_USER_PROMPT,(const void **)&prompt);
	 if (prompt == NULL) prompt = "Who are you? ";
	 (void) pam_get_user(pamh, &user, prompt);
