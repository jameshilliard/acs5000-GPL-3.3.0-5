 ...
 *
 * $Id: uemf.h,v 1.2 2006/02/09 22:59:49 livio Exp $
 */
...
#define gislower	islower
#define gatoi		atoi
#define gdtoa(buf, i) gsprintf(buf, T("%d"), i) /*note that buf must be large enough!*/
...
#define B_MAX_CLASS		15					/* Maximum class number + 1 */
