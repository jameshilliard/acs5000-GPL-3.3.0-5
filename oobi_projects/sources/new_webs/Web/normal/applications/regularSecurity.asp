...
parent.helpPage = '/normal/helpPages/regularSecurityHelp.asp';
      ...
      <tr>
        <td align="center" valign="middle">
          <table border="0" cellpadding="5" cellspacing="0">
            ...
            <tr  height="40" valign="middle">
              <td align="left"><font class="label">Repeat New Password</font></td>
              <td>
...
<form name="configForm" method="POST" action="/goform/Dmf">
  ...
  <input type="hidden" name="urlOk" value="/normal/applications/regularSecurity.asp">
  <input type="hidden" name="urlError" value="/normal/applications/regularSecurity.asp">
