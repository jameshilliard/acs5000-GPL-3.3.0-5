...
// Navigation Tree Functions - navtree.js
//
// Version: 1.02
//
// Art & Logic, Inc.
...
// ****************************************************************************
// Name:        Navigation Tree functions
// Description: Used to create a tree navigation system, similar to Windows Explorer.
// IMPORTANT NOTE: Art & Logic prefers the treemenu.com approach, but this library
// is useful if the treemenu.com approach isn't suitable.
// ****************************************************************************
...
function _writeList() {
  ...
  for(var i = 0; i < this.types.length; i++) {
    ...
    if(this.types[i] == "list") {
      str += "<TD WIDTH=15 NOWRAP VALIGN=MIDDLE><A TARGET='_self' HREF=\"javascript:expand("+this.lists[i].id+");\"><IMG BORDER=0 SRC=\"true.gif\" NAME=\"_img"+this.lists[i].id+"\"></A></TD>";
      _pid++;
    } else if(this.space)
