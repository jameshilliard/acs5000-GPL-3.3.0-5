  ...
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  <p>One <%getLabel("prodname");%> can be used as a Master 
		  to control other <%getLabel("prodname");%> (slaves). This is 
		  called clustering and all ports of the slave unit appear as 
		  if they were in the master unit. This section shows you how 
		  to define and configure the slaves.</p>
		  </font></div></td>
        </tr>
        <tr> 
          <td width="25" height="40">&nbsp;</td>
		...
		<p>Click on [Add] or [Edit] to open a dialog box to enter or modify the slave parameters. Master and Slave communicates using Telnet or SSH, and the ports on the Slave unit appear as an extension of the Master unit.</p>
		<p>To delete a slave from the list, select the unit and click [Delete].</p>
		</font></div></td>
        </tr>
        <tr>
