...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    Network | Firewall Configuration | Edit Rule</td>
  </tr>
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr> 
          <td width="25" height="20">&nbsp;</td>
          <td width="25" align="center" valign="middle" height="20">&nbsp;</td>
        ...
        <tr> 
		  ...
		  Use this section to define the rules for any specific chain. 
		  You can Add new rules or Edit/Delete one existing rule. Up/Down buttons 
		  are used to move one rule across the table. </font></div></td>
        </tr>
        <tr>
