...
<table border="0" cellpadding="0" cellspacing="0" width="101%">
   <tr>
    ...
    <td class="bgColor4" align="left" height="20" width="1">
		<img src="/Images/brownLine.gif" alt="" width="1" height="20" border="0"></td>
	<td class="bgColor4" align="center" width=<%get(width);%> nowrap>
		<a href="javascript:loadNextPagePhysP('/normal/security/secKerbConf.asp')" class="tabsTextAlt">
		<font class="tabsText">Kerberos</font></a></td>
    <td class="bgColor4" align="left" height="20" width="1">
		<img src="/Images/brownLine.gif" alt="" width="1" height="20" border="0"></td>
...
%>
	<td class="bgColor1" align="center" width='16%' nowrap>
		<font class="tabsText">NIS</font></td>
...
if (family_model == "KVM" || family_model == "ONS") {
    ...
    write("<td class=\"bgColor3\" width='");
    write(width);
    write("' >");
    write("<img src=\"/Images/1pixelTrans.gif\" alt=\"\" width=\"1\" height=\"1\" border=\"0\"></td>");
    write("<td class=\"bgColor3\" align=\"center\">")
    write("<img src=\"/Images/1pixelTrans.gif\" alt=\"\" width=\"1\" height=\"1\" border=\"0\"></td>");
}
%>

	  <td class="bgColor1" width=<%get(width);%>><img src="/Images/1pixelTrans.gif" alt="" width='101%' height="1" border="0"></td>
	  <td class="bgColor3" align="center"><img src="/Images/1pixelTrans.gif" alt="" width='101%' height="1" border="0"></td>
      <td class="bgColor3" width=<%get(width);%>><img src="/Images/1pixelTrans.gif" alt="" width='101%' height="1" border="0"></td>
   </tr>
</table>
</body>
</html>
