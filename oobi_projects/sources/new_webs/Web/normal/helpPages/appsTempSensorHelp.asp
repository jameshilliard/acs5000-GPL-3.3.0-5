...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    Applications | Temperature Sensor </td>
  </tr>
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  Here you may choose to connect to the Temperature Sensor running on Port 1 or Port 2, to view the Temperature readings in a graphical format. You can select the option of viewing either a line or a bar graph, and modify the graph display settings as needed. Profile settings can be saved and retrieved from the device. </font></div></td>
        ...
        <tr> 
		  ...
		  To connect to Port 1, select 'Port 1' from the drop-down list and click the 'Connect' button. Follow the same procedure to connect to Port 2.
		  <br>The <%getLabel("nickname");%> will launch a java viewer to make the connection.</font></div></td>
        </tr>
        <tr>
