...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    Administration | Boot Configuration</td>
  </tr>
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  The <%getLabel("prodname");%> can boot from its internal firmware or from the network. 
		  This section configures the required parameters.
		  </font></div></td>
        </tr>
        <tr> 
          <td width="25" height="40">&nbsp;</td>
        ...
        <tr> 
		  ...
		  <p>The unit boots from Flash as default. If you need to boot from network, install 
		  one TFTP or BOOTP server with the firmware to boot from, choose "boot from network" 
		  and fill the fields. Flash test and RAM test can be skipped for a faster boot. Please 
		  refer to the user manual for more details.</p>
		  </font></div></td>
        </tr>
        <tr>
