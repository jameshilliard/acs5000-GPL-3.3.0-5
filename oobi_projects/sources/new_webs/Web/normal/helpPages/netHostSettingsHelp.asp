...
<html>
<head>
	<title>Help/Host Settings</title>
  ...
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  In this section you may configure the <%getLabel("nickname");%> generic network parameters 
		  such as host name, IP address, DNS servers etc.</font></div></td>
        </tr>
        <tr> 
          <td width="25" height="40">&nbsp;</td>
          <td width="25" align="center" valign="middle" height="40"> <img src="../../Images/paragHelp.gif" alt="" width="25" height="25" border="0"></td>
        ...
        <tr> 
		  ...
		  For more detailed explanation of each field see the user manual.</font></div></td>
        </tr>
        <tr>
