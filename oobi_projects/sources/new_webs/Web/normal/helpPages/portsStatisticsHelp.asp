  ...
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  This section shows the information of the physical ports : alias, current CAS user(s), Baud rate, Tx bytes, Rx bytes, frame, parity, break and overruns.
		  </font></div></td>
        </tr>
        <tr> 
          <td width="25" height="40">&nbsp;</td>
        ...
        <tr> 
          ...
          <td width="365" align="left" valign="middle"><div align="justify"><font class="textHelp">N/A</font></div></td>
        </tr>
        <tr>
