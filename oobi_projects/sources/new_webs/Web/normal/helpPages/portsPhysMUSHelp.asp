...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    Ports | Physical Ports | Multi User Settings</td>
  </tr>
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  <p>Choose if you are to allow sniffing or multiple users 
		  connecting to this serial port. Define the users with permissions.</p></font></div></td>
        </tr>
        <tr> 
          <td width="25" height="20">&nbsp;</td>
          <td width="25" align="center" valign="top" height="20"> &nbsp;</td>
