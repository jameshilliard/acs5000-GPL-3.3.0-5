...
public class SSH2KEXDHGroup1SHA1 extends SSH2KeyExchanger {
    ...
    public final static BigInteger group1P =
        com.mindbright.security.publickey.ModPGroups.oakleyGroup2P;

    public final static BigInteger group1G =
        com.mindbright.security.publickey.ModPGroups.oakleyGroup2G;
    ...
    public void processKEXMethodPDU(SSH2TransportPDU pdu) throws SSH2Exception {
        if(pdu.getType() == SSH2.MSG_KEXDH_REPLY) {
            ...
            DHPublicKeySpec srvPubSpec = new DHPublicKeySpec(serverF,
                                         group1P, group1G);
