...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    Ports | Virtual Ports<br>
	New / Modify Port | Name Port</td>
  </tr>
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  <p>You can give an alias name for the ports in the cluster. 
		  Adopting a good naming convention helps. Please refer to the 
		  user manual for details and examples on how to cluster <%getLabel("nickname");%> 
		  units for effective management.</p> 
		  </font></div></td>
        </tr>
        <tr> 
          <td width="25" height="20">&nbsp;</td>
