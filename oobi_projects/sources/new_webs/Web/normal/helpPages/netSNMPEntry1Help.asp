...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    Network | SNMP Daemon Settings<br>Add / Edit SNMP Daemon Configuration v1/v2</td>
  </tr>
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  <p>SNMP v1/v2 requires Community name, Source IP range and OID.
		  Choose the permission you would assign. Please see the manual 
		  for the meaning of the fields and consult with your network administrator 
		  for data regarding your network configuration.</p></font></div></td>
        </tr>
        <tr>
