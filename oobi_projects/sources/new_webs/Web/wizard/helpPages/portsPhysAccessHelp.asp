...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    Ports | Physical Ports | Access</td>
  </tr>
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  <p>Enter the users/groups authorized to access this port, 
		  as well as the authentication process to be used. You will be 
		  asked to fill in additional parameters when authentication 
		  servers are required. Please consult your network administrator 
		  for authentication servers in your network.</p></font></div></td>
        </tr>
        <tr> 
          <td width="25" height="20">&nbsp;</td>
          <td width="25" align="center" valign="top" height="20"> &nbsp;</td>
