...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    Administration | Backup Configuration</td>
  </tr>
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  The <%getLabel("nickname");%> configuration can use a FTP server to save and retrieve its configuration. 
		  </font></div></td>
        </tr>
        <tr> 
          <td width="25" height="40">&nbsp;</td>
        ...
        <tr> 
		  ...
		  <p>Prepare one FTP server on the same subnet and check if it is accessible from the <%getLabel("nickname");%> 
		  (ping the FTP server). Fill in the fields and click on the buttons to save or load. For detailed 
		  descriptions of each field, please refer to the user manual.</p>
		  </font></div></td>
        </tr>
        <tr>
