...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    Network | Firewall Configuration</td>
  </tr>
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  Here you may configure how packets should be filtered for different packets. 
		  </font></div></td>
        </tr>
        <tr> 
          <td width="25" height="40">&nbsp;</td>
        ...
        <tr> 
		  ...
		  You can match packets and filter them in the way you want. 
		  You can drop, accept or reject packets according to their IP. 
		  Click on the [Add] button to add a new entry, or select 
		  one entry to Edit or Delete. To change the rules, click on [Edit Rules] 
		  and then add, delete or add entries to open a dialog box. Fill in the 
		  dialog box to reflect your requirements. Click [Up] and [Down] to 
		  place the entry in the position you want. Rules do change with each 
		  network administration. 
		  <p>Please see the manual for details and consult 
		  with your network administrator.</p>  
		  </font></div></td>
        </tr>
        <tr>
