...
<head>
  ...
  {checkElement (form_location.elements[10], false, false, false, true);} 
  if (form_location.elements[2].value == 1)
	  {	
	    if (continue_verification == true)	 
		{checkElement (form_location.elements[4], true, true, false, false);}
		if (continue_verification == true)    
		{checkElement (form_location.elements[5], true, false, true, false);}
	  }  
  }
   ...
   <form name="bootconfigForm" onSubmit="return false;">
      <table border="0" cellpadding="2" cellspacing="0" width="460" align="center">
         ...
         <tr>
            ...
            <td><font class="label">Boot Type</font></td>
         </tr>
         <tr valign="top">
            <td height="40">
               <font class="formText">
            ...
            <td>
               <font class="formText">
               <% selected = getVal(self + "uBoot"); %>
               <select class="formText" name="uBoot">
               <option value="0" <% if (0 == selected) write("SELECTED"); %>> Flash </option>
               <option value="1" <% if (1 == selected) write("SELECTED"); %>> Network </option>
               </select>
               </font>
            </td>  
            <td>
               <font class="formText">
               <% selected = getVal(self + "bType"); %>
               <select class="formText" name="bType">
               <option value="1" <% if (1 == selected) write("SELECTED"); %>> Bootp </option>
               <option value="2" <% if (2 == selected) write("SELECTED"); %>> Tftp </option>
               <option value="3" <% if (3 == selected) write("SELECTED"); %>> Both </option>
               </select>
               </font>
            </td>  
         </tr>
         ...
         <tr valign="top">
            <td colspan="2" height="40"><input type="text" name="bootFilename" maxlength="39" size="19" value="<%get(self + "bootFilename");%>" class="formText"></td>
         ...
         <tr>
            ...
            <td><font class="label">Flash Test</font></td>
            <td><font class="label">RAM Test</font></td>
         </tr>
         <tr valign="top">
            <td height="40">
               <font class="formText">
            ...
            <td>
               <font class="formText">
               <% selected = getVal(self + "flashTest"); %>
               <select class="formText" name="flashTest">
               <option value="0" <% if (0 == selected) write("SELECTED"); %>> Skip </option>
               <option value="1" <% if (1 == selected) write("SELECTED"); %>> Full </option>
               </select>
               </font>
            </td>  
            <td>
               <font class="formText">
               <% selected = getVal(self + "ramTest"); %>
               <select class="formText" name="ramTest">
               <option value="0" <% if (0 == selected) write("SELECTED"); %>> Skip </option>
               <option value="1" <% if (1 == selected) write("SELECTED"); %>> Quick </option>
               <option value="2" <% if (2 == selected) write("SELECTED"); %>> Full </option>
               </select>
               </font>
            </td>  
         </tr>
...
<form name="configForm" method="POST" action="/goform/Dmf">
   ...
   <input type="hidden" name="urlOk" value="/normal/administration/adminBootConfig.asp">
   <input type="hidden" name="urlError" value="/normal/administration/adminBootConfig.asp">
 ...
 <!--*************************************************************************-->
  <!--these hidden inputs are used to store values of form elements inside layers-->
   ...
   <input type="hidden" name="<%write(self);%>bType" value="">
   ...
   <input type="hidden" name="<%write(self);%>flashTest" value="">
   <input type="hidden" name="<%write(self);%>ramTest" value="">
