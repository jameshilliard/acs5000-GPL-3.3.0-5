 ...
 * copied from FriBidi.
 *
 * $Id: gen-mirroring-tab.c,v 1.1 2007/08/30 20:16:13 const Exp $
 * $Author: const $
 * $Date: 2007/08/30 20:16:13 $
 * $Revision: 1.1 $
 * $Source: /usr/cvsroot/opensource/tools/glib-2.12.13/glib/glib-mirroring-tab/gen-mirroring-tab.c,v $
 *
 * Author:
