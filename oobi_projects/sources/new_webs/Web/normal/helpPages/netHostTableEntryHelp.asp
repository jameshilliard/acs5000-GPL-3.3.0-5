...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <td width="365" align="center" valign="middle" class="titleHelp" nowrap>Help<br>
     Network | Host Table | New / Modify Host</td>
  </tr>
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<p>Enter the IP address and the name of the host computer to be added to the Host Table.</p>
		<p>The Host Table is a small table containing name and address about important hosts on the local network. It may be used when DNS is not available, such as during system startup.</p>
		</font></div></td>
        </tr>
        <tr>
