...
<html>
<head>
	<title>Help/New/Mod SNMP Daemon Configuration</title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    Network | SNMP Daemon Settings<br>Add / Edit SNMP Daemon Configuration v3</td>
  </tr>
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  <p>SNMP v3 requires user name and password compared to IP and community name 
		  of v1/v2. Fill in the OID and choose the permission you plan to assign.</p> 
		  <p>Please see the manual for the meaning of the fields and consult with your network 
		  administrator for data regarding your network configuration.</p></font></div></td>
        </tr>
        <tr>
