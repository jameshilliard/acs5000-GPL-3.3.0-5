...
<% ReqNum = getRequestNumber(); %>	
   ...
   parent.helpPage = 'helpPages/portsStatisticsHelp.asp';
...
<tr>
   ...
   <a href="javascript:loadNextPage('/normal/ports/portsStatistics.asp');"><img src="/Images/refresh_button.gif" alt="" border="0"></a></td>
</tr>
</table>    
<script type="text/javascript">
...
document.write('<td width="200"><font class="tabsTextBig">Baud Rate</font></td>');
document.write('<td width="200"><font class="tabsTextBig">Tx bytes</font></td>');
document.write('<td width="200"><font class="tabsTextBig">Rx bytes</font></td>');
document.write('<td width="200"><font class="tabsTextBig">Frame</font></td>');
document.write('<td width="200"><font class="tabsTextBig">Parity</font></td>');
document.write('<td width="200"><font class="tabsTextBig">Break</font></td>');
document.write('<td><font class="tabsTextBig">Overrun</font></td></tr>');

var portStatus = new Array(<%get("system.ports.portstatistics");%>);
...
for (var j=0; j < numPorts; j++) {
	...
	document.write('<td><font class="label">'+ portStatus[j][2] + '</font></td>');
	document.write('<td><font class="label">'+ portStatus[j][3] + '</font></td>');
	document.write('<td><font class="label">'+ portStatus[j][4] + '</font></td>');
	document.write('<td><font class="label">'+ portStatus[j][5] + '</font></td>');
	document.write('<td><font class="label">'+ portStatus[j][6] + '</font></td>');
	document.write('<td><font class="label">'+ portStatus[j][7] + '</font></td></tr>');
}
...
<form name="configForm" method="POST" action="/goform/Dmf">
   ...
   <input type="hidden" name="urlOk" value="/normal/ports/portsStatistics.asp">
   <input type="hidden" name="urlError" value="/normal/ports/portsStatistics.asp">
