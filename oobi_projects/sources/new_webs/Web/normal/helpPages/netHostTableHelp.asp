  ...
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  This section supplies information about the local network environment.
		  </font></div></td>
        </tr>
        <tr> 
          <td width="25" height="40">&nbsp;</td>
        ...
        <tr> 
		  ...
		  <p>Click on [Add] to add host names and IP addresses on your local network environment. To Edit
		   or Delete a host, click on the host name and then click [Edit] or [Delete].</p>
          Select the host and click [Up] or [Down] to place the host in the desired position in the host table. Please consult the manual for details on this setup.
