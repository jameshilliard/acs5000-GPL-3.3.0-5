...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    Administration | Notifications<br>New / Modify Pager Notification</td>
  </tr>
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  <p>Enter the alarm string to trigger the pager notification, 
		  destination pager number, the text to describe the event, 
		  the SMS user identification and the SMS Server IP address.</p> 
		  <p>Please consult the user manual and the network administrator for further details.</p></font></div></td>
        </tr>
        <tr> 
          <td width="25" height="20">&nbsp;</td>
          <td width="25" align="center" valign="top" height="20"> &nbsp;</td>
