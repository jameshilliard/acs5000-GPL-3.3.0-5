...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    Ports | Physical Ports | Data Buffering</td>
  </tr>
  <tr align="center" valign="middle"> 
    <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  <p>Check the box for the data buffering you are going to use. 
		  Enter the parameters for data buffering or syslog buffering. 
		  Please consult the user manual and the network administrator for details.</p></font></div></td>
        </tr>
        <tr> 
          <td width="25" height="20">&nbsp;</td>
          <td width="25" align="center" valign="top" height="20"> &nbsp;</td>
